<template>
  <div style="height: inherit">
    ...
    <!-- Prodcuts -->
    <section v-if='$store.state.IsAdmin' :class="itemView">
      <b-card
...
export default {
  ...
  created(){
    this.$store.dispatch('StartShopGetter')
  },
  methods:{
    sortByFilter(text){
      this.$store.commit('SetLoader')
      var SortedArray = JSON.parse(JSON.stringify(this.$store.state.AllProducts))
      if(text=='Lowest'){
